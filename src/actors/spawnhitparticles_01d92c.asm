...
; JULY LOCAL REVIEW: spawn up to eight particles on an accepted enemy hit.
; Shared counter caps them at 16; link mode queues kind $09 spawn packets.
        ifne *-$1D92C
...
loc_01D934:
        cmpi.w       #$10, rHitParticleCount(a6)                              ; $01D934
        beq.w        loc_01DA14                                    ; $01D93A
        bsr.w        AllocateActor                                 ; $01D93E
        beq.w        loc_01DA14                                    ; $01D942
        addq.w       #$1, rHitParticleCount(a6)                               ; $01D946
        move.w       $24(a2), ActorX(a0)                           ; $01D94A
        move.w       $26(a2), ActorY(a0)                           ; $01D950
        move.l       #UpdateHitParticle, ActorUpdateCallback(a0) ; $01D956
        move.l       #DrawHitParticle, ActorDrawCallback(a0)                ; $01D95E
        move.l       #RemoveHitParticle, ActorExitCallback(a0) ; $01D966
        ...
        move.l       #QueueActorLinkCommand10StateCounter09, ActorLinkCallback(a0)                ; $01D9C8
        lea.l        rSharedScratchBuffer(a6), a1                                ; $01D9D0
        move.b       #$4, (a1)+                                    ; $01D9D4
        ...
        lea.l        rSharedScratchBuffer(a6), a0                                ; $01DA02
