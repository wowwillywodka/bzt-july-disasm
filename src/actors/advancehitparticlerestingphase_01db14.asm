...
; JULY LOCAL REVIEW: advance the resting particle phase using
; (HitParticleCount+1)>>1; carry falls through to removal.
        ifne *-$1DB14
        fail "ROM start moved"
        endif

AdvanceHitParticleRestingPhase:
...
loc_01DB2E:
        move.w       rHitParticleCount(a6), d0                                ; $01DB2E
        addq.w       #$1, d0                                       ; $01DB32
        asr.w        #$1, d0                                       ; $01DB34
