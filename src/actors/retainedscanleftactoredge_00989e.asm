...
; Retained left-column and bottom-row scans. A0 is the center cell pointer
; in the local 32x32 window; player XY independently control clipping.
        ifne *-$989E
        fail "ROM start moved"
        endif

RetainedScanLeftActorEdge:
; Seven cells at A0-$63 + 32*n (n=0..6); require player X >= $300.
...
RetainedScanBottomActorEdge:
; Seven cells at A0+$5D .. A0+$63; require player Y < $1D00.
