...
; JULY LOCAL REVIEW: 16 XY substeps while flying, then collision,
; vertical motion or the resting-phase animation.
        ifne *-$1DA1A
...
UpdateHitParticle:
        ...
        bne.w        AdvanceHitParticleRestingPhase                       ; $01DA22
        move.w       ActorMotionX(a0), d0                          ; $01DA26
        or.w         ActorMotionY(a0), d0                          ; $01DA2A
        beq.w        AdvanceHitParticleHeight                       ; $01DA2E
...
loc_01DA52:
        ...
        bra.b        CommitHitParticleMotion                       ; $01DA70
...
loc_01DA78:
        addq.w       #$4, a7                                       ; $01DA78
        bra.w        RemoveHitParticle                        ; $01DA7A

loc_01DA7E:
        bsr.w        DisabledActorProjectileSurfaceTest            ; $01DA7E
        bne.b        loc_01DA78                                    ; $01DA82
        move.l       (a7)+, d3                                     ; $01DA84
        move.l       #QueueActorLinkCommand10StateCounter0A, ActorLinkCallback(a0)                ; $01DA86
        asr.l        #$4, d3                                       ; $01DA8E
        asr.l        #$4, d4                                       ; $01DA90
