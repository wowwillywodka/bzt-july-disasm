...
; Initialize scene; load geometry from GeometryEpisode and floor from low nibble of LevelSelection. Its bits 4..5 select legacy music/demo logic, not the geometry bank.
        ...
        clr.b        -$55be(a6)                                    ; $001058
        clr.b        -$55bd(a6)                                    ; $00105C
        move.b       #$5c, -$5590(a6)                              ; $001060
        clr.w        -$558e(a6)                                    ; $001066
        clr.b        -$6f56(a6)                                    ; $00106A
        move.b       #$3, -$6f53(a6)                               ; $00106E
        clr.w        -$559c(a6)                                    ; $001074
...
loc_001100:
        ...
        move.b       rSavedHealth(a6), -$720d(a6)                  ; $001112
        clr.w        rPlayerDeathTicks(a6)                         ; $001118
        jsr          UiRoutine_0116BE.l                            ; $00111C
        move.w       rLegacyEpisodeSelection(a6), d0               ; $001122
        addi.w       #$45, d0                                      ; $001126
        jsr          loc_07ACE4.l                                  ; $00112A
        bsr.w        InitializeVdpRegisters                        ; $001130
        move.w       #$8124, VDP_CONTROL.l                         ; $001134
        bsr.w        SeedRandom                                    ; $00113C
        move.l       rZonePanoramaTilemap(a6), -$5598(a6)          ; $001140
        lea.l        -$7abc(a6), a0                                ; $001146
        move.l       #$ffffffff, (a0)                              ; $00114A
        move.l       a0, rDmaQueueTail(a6)                         ; $001150
        clr.w        -$71ee(a6)                                    ; $001154
        move.w       #$ffe1, -$42f4(a6)                            ; $001158
        clr.w        -$42f8(a6)                                    ; $00115E
        move.w       #$1, -$42f6(a6)                               ; $001162
        clr.w        -$71d8(a6)                                    ; $001168
        clr.w        -$71d4(a6)                                    ; $00116C
        clr.w        -$71d6(a6)                                    ; $001170
        clr.w        -$71d2(a6)                                    ; $001174
        clr.w        -$71ce(a6)                                    ; $001178
        clr.w        -$7158(a6)                                    ; $00117C
        clr.w        -$7156(a6)                                    ; $001180
        clr.w        -$7154(a6)                                    ; $001184
        clr.w        -$7152(a6)                                    ; $001188
        clr.w        -$7202(a6)                                    ; $00118C
        clr.w        -$7200(a6)                                    ; $001190
        move.w       #$ffff, -$214a(a6)                            ; $001194
...
loc_0011EA:
        ...
        move.l       (a0)+, -$7ffa(a6)                             ; $0011F2
        bra.b        loc_001204                                    ; $0011F6

loc_0011F8:
        cmpi.w       #$2, rDemoMode(a6)                            ; $0011F8
        bne.b        loc_001204                                    ; $0011FE
        move.l       -$7ffa(a6), (a0)+                             ; $001200

loc_001204:
        move.l       a0, rDemoInputPointer(a6)                     ; $001204
        lea.l        AngleVectorPairs(pc), a0                      ; $001208
        move.w       -$71ee(a6), d0                                ; $00120C
        lsl.w        #$2, d0                                       ; $001210
        adda.w       d0, a0                                        ; $001212
        move.w       (a0), -$71f2(a6)                              ; $001214
        move.w       $2(a0), -$71f0(a6)                            ; $001218
        clr.w        -$71d0(a6)                                    ; $00121E
        clr.w        -$7212(a6)                                    ; $001222
        clr.w        -$7214(a6)                                    ; $001226
        clr.w        -$5590(a6)                                    ; $00122A
...
; Per-floor color mode is one byte in ZoneFloorColorModes, not a menu selection.
        ...
        clr.w        -$6f58(a6)                                    ; $001254
        clr.w        -$6e4c(a6)                                    ; $001258
        clr.w        -$6e4a(a6)                                    ; $00125C
...
loc_0012E2:
        ...
        move.w       -$539e(a6), -(a7)                             ; $0012F4
        move.w       -$539c(a6), -(a7)                             ; $0012F8
        clr.w        -$539e(a6)                                    ; $0012FC
        move.w       #$2000, -$539c(a6)                            ; $001300
        jsr          TransmitLinkCommands.l                        ; $001306
        move.w       (a7)+, -$539c(a6)                             ; $00130C
        move.w       (a7)+, -$539e(a6)                             ; $001310
...
loc_00133A:
        ...
        move.b       (a1), d1                                      ; $001344
        lsl.w        #$8, d1                                       ; $001346
        move.w       d1, -$6fa2(a6)                                ; $001348
        jsr          UiRoutine_011C78.l                            ; $00134C
...
loc_001352:
        ...
        move.w       #$1, -$711e(a6)                               ; $001378
        bsr.w        UiRoutine_0028C4                              ; $00137E
        move.w       #$1, -$213e(a6)                               ; $001382
        move.w       #$0, -$213c(a6)                               ; $001388
        move.w       #$0, -$213a(a6)                               ; $00138E
        jsr          loc_00C08C.l                                  ; $001394
        jsr          loc_00F216.l                                  ; $00139A
