...
DequeueLinkCommand:
        move.w       rLinkReceiveReadOffset(a6), d0                                ; $020010
        cmp.w        rLinkReceiveWriteOffset(a6), d0                                ; $020014
...
loc_02001E:
        move.l       a0, -(a7)                                     ; $02001E
        lea.l        rLinkReceiveRing(a6), a1                                ; $020020
        clr.w        d1                                            ; $020024
...
loc_020046:
        ...
        move.w       d0, rLinkReceiveReadOffset(a6)                                ; $02004C
