...
TransmitLinkWordInNibbles:
        ...
        move.b       d6, (a3)                                      ; $01FE02
        bset.b       #$5, (a3)                                     ; $01FE04
        move.w       ramLinkTransferModeShadow.l, d5                                 ; $01FE08
...
loc_01FE0E:
        ...
        move.b       d6, (a3)                                      ; $01FE24
        bclr.b       #$5, (a3)                                     ; $01FE26
        move.w       ramLinkTransferModeShadow.l, d5                                 ; $01FE2A
...
loc_01FE30:
        ...
        move.b       d6, (a3)                                      ; $01FE46
        bset.b       #$5, (a3)                                     ; $01FE48
        move.w       ramLinkTransferModeShadow.l, d5                                 ; $01FE4C
...
loc_01FE52:
        ...
        move.b       d6, (a3)                                      ; $01FE68
        bclr.b       #$5, (a3)                                     ; $01FE6A
        move.w       ramLinkTransferModeShadow.l, d5                                 ; $01FE6E
...
loc_01FE82:
        addq.w       #$1, ramLinkTransferFailureCount.l                                ; $01FE82
        rts                                                        ; $01FE88
        ifne *-$1FE8A
        fail "ROM end moved"
        endif
