...
loc_00262C:
        bsr.b        SystemRoutine_002606                          ; $00262C
        bra.w        AppendHardwareSprite                          ; $00262E

loc_002632:
        move.w       -$71ee(a6), d5                                ; $002632
        neg.w        d5                                            ; $002636
        lsl.w        #$1, d5                                       ; $002638
        ...
        sub.w        d0, d5                                        ; $002644
        clr.w        d0                                            ; $002646
        move.b       -$6f55(a6), d0                                ; $002648
        add.w        d0, d5                                        ; $00264C
        andi.w       #$3ff, d5                                     ; $00264E
        bsr.b        RendererRoutine_00267E                        ; $002652
        bra.b        AppendHardwareSprite                          ; $002654

loc_002656:
        move.w       -$71ee(a6), d5                                ; $002656
        neg.w        d5                                            ; $00265A
        lsl.w        #$1, d5                                       ; $00265C
        addi.w       #$20, d5                                      ; $00265E
        ...
        sub.w        d0, d5                                        ; $002668
        clr.w        d0                                            ; $00266A
        move.b       -$6f55(a6), d0                                ; $00266C
        add.w        d0, d5                                        ; $002670
        andi.w       #$3ff, d5                                     ; $002672
        bsr.b        RendererRoutine_00267E                        ; $002676
