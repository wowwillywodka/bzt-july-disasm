...
; JULY LOCAL REVIEW:
; Probes the actor cell and eight neighbours, writes ActorExitCellProfile through
; rCellIndexByType, commits the map cell, optionally sends link command $05,
; then tail-branches to RemoveActor. Its sole literal ROM reference is a
; callback comparison at $020540, not a call or callback installation.
        ifne *-$1D880
        fail "ROM start moved"
        endif

WriteActorExitCellAndRemoveActor:
...
loc_01D8F2:
        ...
        lea.l        rSharedScratchBuffer(a6), a1                                ; $01D908
        move.b       #$5, (a1)                                     ; $01D90C
