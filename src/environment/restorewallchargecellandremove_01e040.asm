...
; Exit callback: put type-$26 cell index at charge position and remove actor.
        ifne *-$1E040
        fail "ROM start moved"
        endif

RestoreWallChargeCellAndRemove:
...
loc_01E06E:
        move.b       rWallChargeCellIndex(a6), (a1)                                ; $01E06E
        move.l       a0, -(a7)                                     ; $01E072
        ...
        lea.l        rSharedScratchBuffer(a6), a1                                ; $01E084
        move.b       #$5, (a1)                                     ; $01E088
