...
; JULY LOCAL REVIEW: Quantize a matched inventory slot's amount for the
; password snapshot: 0 stays 0; otherwise floor((amount*8-1)/capacity).
; A3 points to the slot, A2 to the next saved amount byte, D6 to item ID.
        ifne *-$294FE
        fail "ROM start moved"
        endif

AppendScaledProgressByte:
        move.w       (a3), d0                                      ; $0294FE
