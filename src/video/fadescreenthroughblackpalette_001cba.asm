...
FadeScreenThroughBlackPalette:
        move.l       #BlackFadePalette, rPaletteFadeTargetColorsPointer(a6)                 ; $001CBA
        clr.b        rPaletteFadeComponentIndex(a6)                                    ; $001CC2
        clr.w        rPaletteFadeStableStepCount(a6)                                    ; $001CC6
        movea.l      #VDP_DATA, a4                                 ; $001CCA

loc_001CD0:
        jsr          WaitForVBlank.l                               ; $001CD0
        tst.w        rPaletteFadeStableStepCount(a6)                                    ; $001CD6
        bne.b        loc_001D02                                    ; $001CDA
        move.l       #$c0000000, VDP_CONTROL.l                     ; $001CDC
        lea.l        rPaletteFadeCurrentColors(a6), a0                                ; $001CE6
        move.w       #$3, d7                                       ; $001CEA
...
loc_001D02:
        ...
        cmpi.w       #$2, rPaletteFadeStableStepCount(a6)                               ; $001D0C
