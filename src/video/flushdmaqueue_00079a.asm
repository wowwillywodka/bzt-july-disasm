...
; Consumes seven-word VDP DMA commands from VramDmaCommandQueue until the
; $FFFFFFFF sentinel, waits for each transfer, then resets DmaQueueTail.
        ifne *-$79A
...
FlushDmaQueue:
        ...
        lea.l        rVramDmaCommandQueue(a6), a3                                ; $0007A0
...
loc_0007EC:
        move.l       #ramVramDmaCommandQueue, rDmaQueueTail(a6)                   ; $0007EC
        move.w       (a7)+, sr                                     ; $0007F4
