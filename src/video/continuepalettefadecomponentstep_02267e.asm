...
; JULY LOCAL REVIEW: continuation of StepPaletteFade after a component
; comparison. Expects D1/D2/D3, A0/A1 and DBRA state set by its predecessor;
; not an independently callable screen routine.
        ifne *-$2267E
        fail "ROM start moved"
        endif

ContinuePaletteFadeComponentStep:
        move.w       d3, d6                                        ; $02267E
...
loc_0226FA:
        ...
        cmpi.w       #$14, rPaletteFadeStableStepCount(a6)                              ; $0226FE
        beq.b        loc_022710                                    ; $022704
        addq.w       #$1, rPaletteFadeStableStepCount(a6)                               ; $022706
        rts                                                        ; $02270A

loc_02270C:
        clr.w        rPaletteFadeStableStepCount(a6)                                    ; $02270C
