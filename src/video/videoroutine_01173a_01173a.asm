...
VideoRoutine_01173A:
        tst.w        -$7ffe(a6)                                    ; $01173A
        bne.b        VideoRoutine_01173A                           ; $01173E
        lea.l        rInventorySlots(a6), a0                       ; $011740
        move.l       #$53e00002, VDP_CONTROL.l                     ; $011744
        bsr.b        VideoRoutine_01175E                           ; $01174E
        addq.w       #$4, a0                                       ; $011750
        bsr.b        VideoRoutine_01175E                           ; $011752
        addq.w       #$4, a0                                       ; $011754
        bsr.b        VideoRoutine_01175E                           ; $011756
        addq.w       #$4, a0                                       ; $011758
        bsr.b        VideoRoutine_01175E                           ; $01175A
        addq.w       #$4, a0                                       ; $01175C
        ifne *-$1175E
        fail "ROM end moved"
        endif
