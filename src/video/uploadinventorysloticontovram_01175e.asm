...
UploadInventorySlotIconToVram:
; Direct calls address the current A0 slot; fallthrough from $01175C advances A0 by four first. Caller establishes VDP write position.
...
loc_011778:
        ...
        lsr.w        #$8, d0                                       ; $011784
        addq.w       #$1, d0                                       ; $011786
        jsr          DrawInventoryQuantityDigits.l                            ; $011788
        adda.w       #$18, a1                                      ; $01178E
        move.w       #$5f, d6                                      ; $011792
