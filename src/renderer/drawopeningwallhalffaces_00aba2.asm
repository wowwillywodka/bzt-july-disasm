...
loc_00ABB8:
        ...
        addi.w       #$80, d1                                      ; $00ABC6
        move.w       d3, -(a7)                                     ; $00ABCA
        bsr.w        TransformSegmentEndpointBToCamera                        ; $00ABCC
        addi.w       #$80, d0                                      ; $00ABD0
        bsr.w        TransformSegmentEndpointAToCamera                        ; $00ABD4
        movem.w      d0-d1, -(a7)                                  ; $00ABD8
        move.l       #$ff8e0a, rCurrentWallTilePair(a6)            ; $00ABDC
        bsr.w        ProjectWallFaceOnly                           ; $00ABE4
        asr.w        rWallTextureUStart(a6)                                    ; $00ABE8
        asr.w        rWallTextureUEnd(a6)                                    ; $00ABEC
        bsr.w        DrawWallTextureSpan                           ; $00ABF0
        movem.w      (a7)+, d0-d1                                  ; $00ABF4
        move.w       (a7)+, d3                                     ; $00ABF8
        add.w        d3, d0                                        ; $00ABFA
        add.w        d3, d0                                        ; $00ABFC
        bsr.w        TransformSegmentEndpointBToCamera                        ; $00ABFE
        addi.w       #$80, d0                                      ; $00AC02
        bsr.w        TransformSegmentEndpointAToCamera                        ; $00AC06
        move.l       #$ff8e12, rCurrentWallTilePair(a6)            ; $00AC0A
        bsr.w        ProjectWallFaceOnly                           ; $00AC12
        asr.w        rWallTextureUStart(a6)                                    ; $00AC16
        asr.w        rWallTextureUEnd(a6)                                    ; $00AC1A
...
loc_00AC2A:
        ...
        addi.w       #$80, d1                                      ; $00AC38
        move.w       d3, -(a7)                                     ; $00AC3C
        bsr.w        TransformSegmentEndpointAToCamera                        ; $00AC3E
        addi.w       #$80, d0                                      ; $00AC42
        bsr.w        TransformSegmentEndpointBToCamera                        ; $00AC46
        movem.w      d0-d1, -(a7)                                  ; $00AC4A
        move.l       #$ff8e12, rCurrentWallTilePair(a6)            ; $00AC4E
        bsr.w        ProjectWallFaceOnly                           ; $00AC56
        asr.w        rWallTextureUStart(a6)                                    ; $00AC5A
        asr.w        rWallTextureUEnd(a6)                                    ; $00AC5E
        bsr.w        DrawWallTextureSpan                           ; $00AC62
        movem.w      (a7)+, d0-d1                                  ; $00AC66
        move.w       (a7)+, d3                                     ; $00AC6A
        add.w        d3, d0                                        ; $00AC6C
        add.w        d3, d0                                        ; $00AC6E
        bsr.w        TransformSegmentEndpointAToCamera                        ; $00AC70
        addi.w       #$80, d0                                      ; $00AC74
        bsr.w        TransformSegmentEndpointBToCamera                        ; $00AC78
        move.l       #$ff8e0a, rCurrentWallTilePair(a6)            ; $00AC7C
        bsr.w        ProjectWallFaceOnly                           ; $00AC84
        asr.w        rWallTextureUStart(a6)                                    ; $00AC88
        asr.w        rWallTextureUEnd(a6)                                    ; $00AC8C
