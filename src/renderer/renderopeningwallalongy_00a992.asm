...
; Render type $2E opening: slide two half spans along Y using the transient amount. At $80 omit the face. Player/enemy collision class is already zero.
        lea.l        -$7008(a6), a3                                ; $00A992
        cmpa.l       -$7118(a6), a3                                ; $00A996
        beq.b        loc_00A9A8                                    ; $00A99A

loc_00A99C:
        cmpa.l       (a3)+, a0                                     ; $00A99C
        beq.w        loc_00AA4C                                    ; $00A99E
        cmpa.l       -$7118(a6), a3                                ; $00A9A2
        bne.b        loc_00A99C                                    ; $00A9A6

loc_00A9A8:
        move.l       a0, (a3)+                                     ; $00A9A8
        move.l       a3, -$7118(a6)                                ; $00A9AA
...
loc_00AAC2:
        move.l       a0, -$42a2(a6)                                ; $00AAC2
        bsr.w        RendererRoutine_00D122                        ; $00AAC6
        st.b         -$715a(a6)                                    ; $00AACA
        lea.l        -$7030(a6), a3                                ; $00AACE
        cmpa.l       -$711c(a6), a3                                ; $00AAD2
        beq.b        loc_00AAE4                                    ; $00AAD6

loc_00AAD8:
        cmpa.l       (a3)+, a0                                     ; $00AAD8
        beq.w        loc_00AB38                                    ; $00AADA
        cmpa.l       -$711c(a6), a3                                ; $00AADE
        bne.b        loc_00AAD8                                    ; $00AAE2

loc_00AAE4:
        move.l       a0, (a3)+                                     ; $00AAE4
        move.l       a3, -$711c(a6)                                ; $00AAE6
        clr.l        -$6e46(a6)                                    ; $00AAEA
        clr.l        -$6e42(a6)                                    ; $00AAEE
        clr.w        -$6e48(a6)                                    ; $00AAF2
        movem.l      d0-d2/d4-d7/a0-a1/a4-a5, -(a7)                ; $00AAF6
        tst.w        d1                                            ; $00AAFA
        bmi.b        loc_00AB0C                                    ; $00AAFC
        bne.w        loc_00AB3C                                    ; $00AAFE
        cmpi.w       #$80, -$71e2(a6)                              ; $00AB02
...
loc_00AB0C:
        ...
        lsl.w        #$8, d1                                       ; $00AB16
        addi.w       #$80, d1                                      ; $00AB18
        bsr.w        RendererRoutine_00D1D6                        ; $00AB1C
        addi.w       #$100, d0                                     ; $00AB20
        bsr.w        RendererRoutine_00D232                        ; $00AB24
...
loc_00AB3C:
        ...
        lsl.w        #$8, d1                                       ; $00AB46
        addi.w       #$80, d1                                      ; $00AB48
        bsr.w        RendererRoutine_00D232                        ; $00AB4C
        addi.w       #$100, d0                                     ; $00AB50
        bsr.w        RendererRoutine_00D1D6                        ; $00AB54
