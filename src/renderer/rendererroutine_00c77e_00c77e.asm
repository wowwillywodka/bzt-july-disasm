...
; Зонд клетки Y-луча: celltype через (0,A5,D3), спецслучай type4 с краевым тестом по (2,A4); меняет банки D0-D4/A0-A1 чтобы переиспользовать 0x8b50 на ортогональном луче
        ifne *-$C77E
        fail "ROM start moved"
        endif

RendererRoutine_00C77E:
        andi.w       #$ff, d3                                      ; $00C77E
...
loc_00C7C2:
        cmpa.l       -$715e(a6), a0                                ; $00C7C2
        beq.w        loc_00C71A                                    ; $00C7C6
        move.l       a0, -$715e(a6)                                ; $00C7CA
        clr.w        d4                                            ; $00C7CE
        move.b       (a0), d4                                      ; $00C7D0
; Cell index * 8: four word texture IDs per cell; map width is unrelated to this fixed record size.
        ...
        move.l       a0, -$42a2(a6)                                ; $00C7DE
        add.w        rPlayerCellX(a6), d0                          ; $00C7E2
        lsl.w        #$8, d0                                       ; $00C7E6
        add.w        rPlayerCellY(a6), d1                          ; $00C7E8
        lsl.w        #$8, d1                                       ; $00C7EC
        bra.w        RendererRoutine_00CEEA                        ; $00C7EE

loc_00C7F2:
        cmpa.l       -$715e(a6), a1                                ; $00C7F2
        beq.w        loc_00C71A                                    ; $00C7F6
        move.w       d4, d0                                        ; $00C7FA
        move.w       d5, d1                                        ; $00C7FC
        move.w       d6, d2                                        ; $00C7FE
        movea.l      a1, a0                                        ; $00C800
        move.l       a0, -$715e(a6)                                ; $00C802
        clr.w        d4                                            ; $00C806
        move.b       (a0), d4                                      ; $00C808
        lsl.w        #$3, d4                                       ; $00C80A
        ...
        bsr.w        RendererRoutine_00CE68                        ; $00C84C
        movem.w      (a7)+, d0-d1/d3                               ; $00C850
        bra.w        RendererRoutine_00CEEA                        ; $00C854

loc_00C858:
        bra.w        RendererRoutine_00CE68                        ; $00C858
...
loc_00C85C:
        ...
        move.w       -$71e8(a6), d2                                ; $00C880
        mulu.w       (a4), d2                                      ; $00C884
        lsr.l        #$8, d2                                       ; $00C886
        add.w        -$71e6(a6), d2                                ; $00C888
        cmp.w        d7, d2                                        ; $00C88C
...
loc_00C898:
        move.w       -$71e2(a6), d6                                ; $00C898
        mulu.w       $2(a4), d6                                    ; $00C89C
        lsr.l        #$8, d6                                       ; $00C8A0
        add.w        -$71e4(a6), d6                                ; $00C8A2
        cmp.w        d7, d6                                        ; $00C8A6
...
loc_00C8EA:
        cmp.w        -$71a0(a6), d0                                ; $00C8EA
        bgt.b        loc_00C91E                                    ; $00C8EE
        cmp.w        -$71a4(a6), d1                                ; $00C8F0
        blt.b        loc_00C91E                                    ; $00C8F4
        move.b       (a0), d3                                      ; $00C8F6
        beq.b        loc_00C900                                    ; $00C8F8
        bsr.b        RendererRoutine_00C952                        ; $00C8FA
...
loc_00C904:
        cmp.w        -$71a0(a6), d4                                ; $00C904
        bgt.b        loc_00C91E                                    ; $00C908
        cmp.w        -$71a4(a6), d5                                ; $00C90A
        blt.b        loc_00C91E                                    ; $00C90E
        move.b       (a1), d3                                      ; $00C910
        beq.b        loc_00C91A                                    ; $00C912
        bsr.b        RendererRoutine_00C982                        ; $00C914
