...
loc_00C9C6:
        cmpa.l       -$715e(a6), a0                                ; $00C9C6
        beq.w        loc_00C91E                                    ; $00C9CA
        move.l       a0, -$715e(a6)                                ; $00C9CE
        clr.w        d4                                            ; $00C9D2
        move.b       (a0), d4                                      ; $00C9D4
        lsl.w        #$3, d4                                       ; $00C9D6
        ...
        bsr.w        RendererRoutine_00CEEA                        ; $00CA18
        movem.w      (a7)+, d0-d1/d3                               ; $00CA1C
        bra.w        RendererRoutine_00CEA6                        ; $00CA20

loc_00CA24:
        bra.w        RendererRoutine_00CEEA                        ; $00CA24

loc_00CA28:
        cmpa.l       -$715e(a6), a1                                ; $00CA28
        beq.w        loc_00C91E                                    ; $00CA2C
        move.w       d4, d0                                        ; $00CA30
        move.w       d5, d1                                        ; $00CA32
        move.w       d6, d2                                        ; $00CA34
        movea.l      a1, a0                                        ; $00CA36
        move.l       a0, -$715e(a6)                                ; $00CA38
        clr.w        d4                                            ; $00CA3C
        move.b       (a0), d4                                      ; $00CA3E
        lsl.w        #$3, d4                                       ; $00CA40
...
loc_00CA60:
        ...
        move.w       -$71e4(a6), d2                                ; $00CA84
        mulu.w       (a4), d2                                      ; $00CA88
        lsr.l        #$8, d2                                       ; $00CA8A
        add.w        -$71e6(a6), d2                                ; $00CA8C
        cmp.w        d7, d2                                        ; $00CA90
...
loc_00CA9C:
        move.w       -$71e2(a6), d6                                ; $00CA9C
        mulu.w       $2(a4), d6                                    ; $00CAA0
        lsr.l        #$8, d6                                       ; $00CAA4
        add.w        -$71e8(a6), d6                                ; $00CAA6
        cmp.w        d7, d6                                        ; $00CAAA
...
loc_00CAEE:
        cmp.w        -$719e(a6), d0                                ; $00CAEE
        blt.b        loc_00CB22                                    ; $00CAF2
        cmp.w        -$71a4(a6), d1                                ; $00CAF4
        blt.b        loc_00CB22                                    ; $00CAF8
        move.b       (a0), d3                                      ; $00CAFA
        beq.b        loc_00CB04                                    ; $00CAFC
        bsr.b        RendererRoutine_00CB56                        ; $00CAFE
...
loc_00CB08:
        cmp.w        -$719e(a6), d4                                ; $00CB08
        blt.b        loc_00CB22                                    ; $00CB0C
        cmp.w        -$71a4(a6), d5                                ; $00CB0E
        blt.b        loc_00CB22                                    ; $00CB12
        move.b       (a1), d3                                      ; $00CB14
        beq.b        loc_00CB1E                                    ; $00CB16
        bsr.b        RendererRoutine_00CB86                        ; $00CB18
