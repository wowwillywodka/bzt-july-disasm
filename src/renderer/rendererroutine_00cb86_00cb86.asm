...
loc_00CBCA:
        cmpa.l       -$715e(a6), a0                                ; $00CBCA
        beq.w        loc_00CB22                                    ; $00CBCE
        move.l       a0, -$715e(a6)                                ; $00CBD2
        clr.w        d4                                            ; $00CBD6
        move.b       (a0), d4                                      ; $00CBD8
        lsl.w        #$3, d4                                       ; $00CBDA
        ...
        move.l       a0, -$42a2(a6)                                ; $00CBE6
        add.w        rPlayerCellX(a6), d0                          ; $00CBEA
        lsl.w        #$8, d0                                       ; $00CBEE
        add.w        rPlayerCellY(a6), d1                          ; $00CBF0
        lsl.w        #$8, d1                                       ; $00CBF4
        bra.w        RendererRoutine_00CF2A                        ; $00CBF6

loc_00CBFA:
        cmpa.l       -$715e(a6), a1                                ; $00CBFA
        beq.w        loc_00CB22                                    ; $00CBFE
        move.w       d4, d0                                        ; $00CC02
        move.w       d5, d1                                        ; $00CC04
        move.w       d6, d2                                        ; $00CC06
        movea.l      a1, a0                                        ; $00CC08
        move.l       a0, -$715e(a6)                                ; $00CC0A
        clr.w        d4                                            ; $00CC0E
        move.b       (a0), d4                                      ; $00CC10
        lsl.w        #$3, d4                                       ; $00CC12
        ...
        bsr.w        RendererRoutine_00CEA6                        ; $00CC54
        movem.w      (a7)+, d0-d1/d3                               ; $00CC58
        bra.w        RendererRoutine_00CF2A                        ; $00CC5C

loc_00CC60:
        bra.w        RendererRoutine_00CEA6                        ; $00CC60
...
loc_00CC64:
        ...
        move.w       -$71e4(a6), d2                                ; $00CC88
        mulu.w       (a4), d2                                      ; $00CC8C
        lsr.l        #$8, d2                                       ; $00CC8E
        add.w        -$71e2(a6), d2                                ; $00CC90
        cmp.w        d7, d2                                        ; $00CC94
...
loc_00CCA0:
        move.w       -$71e6(a6), d6                                ; $00CCA0
        mulu.w       $2(a4), d6                                    ; $00CCA4
        lsr.l        #$8, d6                                       ; $00CCA8
        add.w        -$71e8(a6), d6                                ; $00CCAA
        cmp.w        d7, d6                                        ; $00CCAE
...
loc_00CCF2:
        cmp.w        -$719e(a6), d0                                ; $00CCF2
        blt.b        loc_00CD26                                    ; $00CCF6
        cmp.w        -$71a2(a6), d1                                ; $00CCF8
        bgt.b        loc_00CD26                                    ; $00CCFC
        move.b       (a0), d3                                      ; $00CCFE
        beq.b        loc_00CD08                                    ; $00CD00
        bsr.b        RendererRoutine_00CD5A                        ; $00CD02
...
loc_00CD0C:
        cmp.w        -$719e(a6), d4                                ; $00CD0C
        blt.b        loc_00CD26                                    ; $00CD10
        cmp.w        -$71a2(a6), d5                                ; $00CD12
        bgt.b        loc_00CD26                                    ; $00CD16
        move.b       (a1), d3                                      ; $00CD18
        beq.b        loc_00CD22                                    ; $00CD1A
        bsr.b        RendererRoutine_00CD8A                        ; $00CD1C
