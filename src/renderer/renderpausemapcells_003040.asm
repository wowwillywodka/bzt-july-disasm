...
; Pause-map cell renderer, called only by RunPauseMapLoop. It selects one of
; eight 14-byte cell patterns from two packed map nibbles, then writes tile
; pixels directly to VDP_DATA. The sign of $FF5EB6 selects its two passes.
        ifne *-$3040
        fail "ROM start moved"
        endif

RenderPauseMapCells:
        tst.w        rPauseMapRenderPassSelector(a6)                                    ; $003040
        ...
        add.w        rPauseMapPanX(a6), d0                                ; $003062
...
loc_00306A:
        ...
        add.w        rPauseMapPanY(a6), d0                                ; $003072
        mulu.w       rCurrentFloorWidth(a6), d0                    ; $003076
        lsr.w        #$1, d0                                       ; $00307A
        adda.w       d0, a0                                        ; $00307C
        lea.l        rCellTypeByIndex(a6), a5                      ; $00307E
        lea.l        PauseMapCellTilePatternPointers(pc), a3              ; $003082
...
loc_003256:
        ...
        add.w        rPauseMapPanX(a6), d0                                ; $003270
...
loc_003278:
        ...
        add.w        rPauseMapPanY(a6), d0                                ; $003280
        mulu.w       rCurrentFloorWidth(a6), d0                    ; $003284
        lsr.w        #$1, d0                                       ; $003288
        adda.w       d0, a0                                        ; $00328A
        lea.l        rCellTypeByIndex(a6), a5                      ; $00328C
        lea.l        PauseMapCellTilePatternPointers(pc), a3              ; $003290
