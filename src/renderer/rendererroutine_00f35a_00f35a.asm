...
; Сборщик вида/списка спрайтов: вычисление указателя карты из камеры+позиции игрока, настройка скана клеток, вызов диспетчеров celltype (bsr 0xed6c/0xedaa)
        ifne *-$F35A
        fail "ROM start moved"
        endif

RendererRoutine_00F35A:
        tst.w        -$214a(a6)                                    ; $00F35A
        bpl.w        loc_00F552                                    ; $00F35E
        movea.l      -$7fc2(a6), a2                                ; $00F362
        ...
        bsr.w        EnvironmentRoutine_00ED6C                     ; $00F3BC
        ...
        move.l       a2, -(a7)                                     ; $00F3D2
        bsr.w        EnvironmentRoutine_00EDAA                     ; $00F3D4
...
loc_00F3DC:
        ...
        lsr.w        #$1, d0                                       ; $00F40A
        adda.w       d0, a0                                        ; $00F40C
        clr.b        -$42a4(a6)                                    ; $00F40E
        andi.w       #$1, d7                                       ; $00F412
        beq.b        loc_00F41E                                    ; $00F416
        move.b       #$1, -$42a4(a6)                               ; $00F418

loc_00F41E:
        move.w       -$7208(a6), d0                                ; $00F41E
        asr.w        #$8, d0                                       ; $00F422
        subq.w       #$5, d0                                       ; $00F424
...
loc_00F474:
        clr.w        d0                                            ; $00F474
        clr.w        d3                                            ; $00F476
        move.b       -$42a4(a6), d3                                ; $00F478
        eori.b       #$1, -$42a4(a6)                               ; $00F47C
        andi.w       #$1, d3                                       ; $00F482
...
loc_00F498:
        ...
        move.b       d3, -$719c(a6)                                ; $00F4A0
        clr.w        d3                                            ; $00F4A4
        move.b       d0, d3                                        ; $00F4A6
        cmpi.b       #$85, -$719c(a6)                              ; $00F4A8
        bne.b        loc_00F4CA                                    ; $00F4AE
        move.w       d4, (a2)+                                     ; $00F4B0
        move.w       -$7fbe(a6), d0                                ; $00F4B2
        ori.w        #$0, d0                                       ; $00F4B6
        move.w       d0, (a2)+                                     ; $00F4BA
        addq.w       #$1, -$7fbe(a6)                               ; $00F4BC
        addq.w       #$5, d5                                       ; $00F4C0
        move.w       d5, (a2)+                                     ; $00F4C2
        subq.w       #$5, d5                                       ; $00F4C4
        move.w       d1, (a2)+                                     ; $00F4C6
...
loc_00F4CA:
        tst.w        -$6f68(a6)                                    ; $00F4CA
        bmi.w        loc_00F506                                    ; $00F4CE
        cmpi.b       #$29, -$719c(a6)                              ; $00F4D2
        bcs.b        loc_00F506                                    ; $00F4D8
        cmpi.b       #$2b, -$719c(a6)                              ; $00F4DA
        bls.b        loc_00F4F2                                    ; $00F4E0
        cmpi.b       #$65, -$719c(a6)                              ; $00F4E2
        bcs.b        loc_00F506                                    ; $00F4E8
        cmpi.b       #$6b, -$719c(a6)                              ; $00F4EA
        bhi.b        loc_00F506                                    ; $00F4F0

loc_00F4F2:
        move.w       d4, (a2)+                                     ; $00F4F2
        move.w       -$7fbe(a6), d0                                ; $00F4F4
        ori.w        #$0, d0                                       ; $00F4F8
        move.w       d0, (a2)+                                     ; $00F4FC
        addq.w       #$1, -$7fbe(a6)                               ; $00F4FE
        move.w       d5, (a2)+                                     ; $00F502
        move.w       d1, (a2)+                                     ; $00F504
...
loc_00F506:
        ...
        subq.w       #$5, d5                                       ; $00F520
        bsr.w        RendererRoutine_00F28C                        ; $00F522
        addq.w       #$5, d5                                       ; $00F526
        bsr.w        RendererRoutine_00F6B0                        ; $00F528
        move.l       a2, -$7fc2(a6)                                ; $00F52C
        rts                                                        ; $00F530
        ifne *-$F532
        fail "ROM end moved"
        endif
