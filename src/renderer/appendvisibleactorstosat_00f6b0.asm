...
AppendVisibleActorsToSat:
        move.w       rActiveActorCount(a6), d2                     ; $00F6B0
        beq.w        loc_00F734                                    ; $00F6B4
        subq.w       #$1, d2                                       ; $00F6B8
        movea.l      rActiveActorHead(a6), a0                      ; $00F6BA
        move.w       rMapSpriteViewCenterX(a6), d6                                ; $00F6BE
        clr.b        d6                                            ; $00F6C2
        move.w       rMapSpriteViewCenterY(a6), d7                                ; $00F6C4
        clr.b        d7                                            ; $00F6C8
        move.w       d6, d4                                        ; $00F6CA
        move.w       d7, d3                                        ; $00F6CC
...
loc_00F6DE:
        ...
        move.w       d1, (a2)+                                     ; $00F714
        move.w       rSpriteAttributeNextLink(a6), d1                                ; $00F716
        ori.w        #$0, d1                                       ; $00F71A
        move.w       d1, (a2)+                                     ; $00F71E
        addq.w       #$1, rSpriteAttributeNextLink(a6)                               ; $00F720
        move.w       d5, (a2)+                                     ; $00F724
        asr.w        #$5, d0                                       ; $00F726
        addi.w       #$e6, d0                                      ; $00F728
        move.w       d0, (a2)+                                     ; $00F72C
