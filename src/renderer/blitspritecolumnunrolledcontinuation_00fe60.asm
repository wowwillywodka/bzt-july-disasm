...
; JULY LOCAL REVIEW: continuation of the computed-entry sprite-column blitter.
; Table entries target many internal labels; zero remapped pixels skip writes.
; A2 supplies source indices, A1 maps indices, A3 supplies colour bytes,
; A0 advances by four bytes per destination pixel.
        ifne *-$FE60
        fail "ROM start moved"
        endif

BlitSpriteColumnUnrolledContinuation:
        move.b       (a2)+, d1                                     ; $00FE60
