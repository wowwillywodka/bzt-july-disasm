...
; JULY LOCAL REVIEW:
; Trace one camera ray through the visible 32-wide map window. Exact cardinal
; headings use straight cell walks; intermediate headings enter paired DDA
; walks. Cell indices map through CellTypeByIndex before DispatchVisibleCell;
; wall faces pass to the projection handlers at $CE68..$D0F2.
...
TraceVisibleMapRay:
        clr.l        rWallFaceHeightProfile0(a6)                                    ; $00C3AA
        clr.l        rWallFaceHeightProfile2(a6)                                    ; $00C3AE
        clr.w        rCurrentWallFaceHeightProfile(a6)                                    ; $00C3B2
        clr.w        rCellSideEffectsSuppressed(a6)                                    ; $00C3B6
        ...
        bcs.w        TraceRayQuadrantFour                                    ; $00C3CE
        bhi.w        TraceRayQuadrantThree                                    ; $00C3D2
...
loc_00C41A:
        ...
        suba.w       d2, a0                                        ; $00C41E
        subq.w       #$1, d1                                       ; $00C420
        cmp.w        rVisibleRayMinLocalY(a6), d1                                ; $00C422
...
loc_00C43E:
        cmpa.l       rCurrentWallMapCellPointer(a6), a0                                ; $00C43E
        beq.b        loc_00C48A                                    ; $00C442
        move.l       a0, rCurrentWallMapCellPointer(a6)                                ; $00C444
        ...
        move.l       a0, rCellRenderStateSourcePointer(a6)                                ; $00C464
        cmpi.b       #$2, d3                                       ; $00C468
        bne.b        loc_00C472                                    ; $00C46C
        bra.w        RenderDiagonalCellFaceClass2                        ; $00C46E

loc_00C472:
        cmpi.b       #$5, d3                                       ; $00C472
        bne.b        loc_00C47C                                    ; $00C476
        bra.w        RenderDiagonalCellFaceClass5                        ; $00C478

loc_00C47C:
        bra.w        RenderWallEdgeY1                        ; $00C47C

loc_00C480:
        suba.w       d2, a0                                        ; $00C480
        subq.w       #$1, d1                                       ; $00C482
        cmp.w        rVisibleRayMinLocalY(a6), d1                                ; $00C484
...
loc_00C4B6:
        ...
        adda.w       d2, a0                                        ; $00C4BA
        addq.w       #$1, d1                                       ; $00C4BC
        cmp.w        rVisibleRayMaxLocalY(a6), d1                                ; $00C4BE
...
loc_00C4DA:
        cmpa.l       rCurrentWallMapCellPointer(a6), a0                                ; $00C4DA
        beq.b        loc_00C526                                    ; $00C4DE
        move.l       a0, rCurrentWallMapCellPointer(a6)                                ; $00C4E0
        ...
        move.l       a0, rCellRenderStateSourcePointer(a6)                                ; $00C500
        cmpi.b       #$3, d3                                       ; $00C504
        bne.b        loc_00C50E                                    ; $00C508
        bra.w        RenderDiagonalCellFaceClass3                        ; $00C50A

loc_00C50E:
        cmpi.b       #$4, d3                                       ; $00C50E
        bne.b        loc_00C518                                    ; $00C512
        bra.w        RenderDiagonalCellFaceClass4                        ; $00C514

loc_00C518:
        bra.w        RenderWallEdgeY0                        ; $00C518

loc_00C51C:
        adda.w       d2, a0                                        ; $00C51C
        addq.w       #$1, d1                                       ; $00C51E
        cmp.w        rVisibleRayMaxLocalY(a6), d1                                ; $00C520
...
loc_00C552:
        addq.w       #$1, a0                                       ; $00C552
        addq.w       #$1, d0                                       ; $00C554
        cmp.w        rVisibleRayMaxLocalX(a6), d0                                ; $00C556
...
loc_00C572:
        cmpa.l       rCurrentWallMapCellPointer(a6), a0                                ; $00C572
        beq.b        loc_00C5BE                                    ; $00C576
        move.l       a0, rCurrentWallMapCellPointer(a6)                                ; $00C578
        ...
        move.l       a0, rCellRenderStateSourcePointer(a6)                                ; $00C598
        cmpi.b       #$2, d3                                       ; $00C59C
        bne.b        loc_00C5A6                                    ; $00C5A0
        bra.w        RenderDiagonalCellFaceClass2                        ; $00C5A2

loc_00C5A6:
        cmpi.b       #$3, d3                                       ; $00C5A6
        bne.b        loc_00C5B0                                    ; $00C5AA
        bra.w        RenderDiagonalCellFaceClass3                        ; $00C5AC

loc_00C5B0:
        bra.w        RenderWallEdgeX0                        ; $00C5B0

loc_00C5B4:
        addq.w       #$1, a0                                       ; $00C5B4
        addq.w       #$1, d0                                       ; $00C5B6
        cmp.w        rVisibleRayMaxLocalX(a6), d0                                ; $00C5B8
...
loc_00C5EA:
        subq.w       #$1, a0                                       ; $00C5EA
        subq.w       #$1, d0                                       ; $00C5EC
        cmp.w        rVisibleRayMinLocalX(a6), d0                                ; $00C5EE
...
loc_00C60A:
        cmpa.l       rCurrentWallMapCellPointer(a6), a0                                ; $00C60A
        beq.b        loc_00C656                                    ; $00C60E
        move.l       a0, rCurrentWallMapCellPointer(a6)                                ; $00C610
        ...
        move.l       a0, rCellRenderStateSourcePointer(a6)                                ; $00C630
        cmpi.b       #$4, d3                                       ; $00C634
        bne.b        loc_00C63E                                    ; $00C638
        bra.w        RenderDiagonalCellFaceClass4                        ; $00C63A

loc_00C63E:
        cmpi.b       #$5, d3                                       ; $00C63E
        bne.b        loc_00C648                                    ; $00C642
        bra.w        RenderDiagonalCellFaceClass5                        ; $00C644

loc_00C648:
        bra.w        RenderWallEdgeX1                        ; $00C648

loc_00C64C:
        subq.w       #$1, a0                                       ; $00C64C
        subq.w       #$1, d0                                       ; $00C64E
        cmp.w        rVisibleRayMinLocalX(a6), d0                                ; $00C650
...
loc_00C658:
        ...
        move.w       rPlayerCellFractionXComplement(a6), d2                                ; $00C67C
        mulu.w       (a4), d2                                      ; $00C680
        lsr.l        #$8, d2                                       ; $00C682
        add.w        rPlayerCellFractionY(a6), d2                                ; $00C684
        cmp.w        d7, d2                                        ; $00C688
...
loc_00C694:
        move.w       rPlayerCellFractionYComplement(a6), d6                                ; $00C694
        mulu.w       $2(a4), d6                                    ; $00C698
        lsr.l        #$8, d6                                       ; $00C69C
        add.w        rPlayerCellFractionX(a6), d6                                ; $00C69E
        cmp.w        d7, d6                                        ; $00C6A2
...
loc_00C6E6:
        cmp.w        rVisibleRayMaxLocalX(a6), d0                                ; $00C6E6
        bgt.b        loc_00C71A                                    ; $00C6EA
        cmp.w        rVisibleRayMaxLocalY(a6), d1                                ; $00C6EC
        bgt.b        loc_00C71A                                    ; $00C6F0
        move.b       (a0), d3                                      ; $00C6F2
        beq.b        loc_00C6FC                                    ; $00C6F4
        bsr.b        ProbeXSteppedRayCell                        ; $00C6F6
...
loc_00C700:
        cmp.w        rVisibleRayMaxLocalX(a6), d4                                ; $00C700
        bgt.b        loc_00C71A                                    ; $00C704
        cmp.w        rVisibleRayMaxLocalY(a6), d5                                ; $00C706
        bgt.b        loc_00C71A                                    ; $00C70A
        move.b       (a1), d3                                      ; $00C70C
        beq.b        loc_00C716                                    ; $00C70E
        bsr.b        ProbeYSteppedRayCell                        ; $00C710
