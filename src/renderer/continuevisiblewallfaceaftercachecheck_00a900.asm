...
ContinueVisibleWallFaceAfterCacheCheck:
        beq.w        loc_00A95E                                    ; $00A900
        cmpa.l       rVisibleWallYCacheEnd(a6), a3                                ; $00A904
        bne.b        loc_00A8FE                                    ; $00A908

loc_00A90A:
        move.l       a0, (a3)+                                     ; $00A90A
        move.l       a3, rVisibleWallYCacheEnd(a6)                                ; $00A90C
        clr.l        rWallFaceHeightProfile0(a6)                                    ; $00A910
        clr.l        rWallFaceHeightProfile2(a6)                                    ; $00A914
        clr.w        rCurrentWallFaceHeightProfile(a6)                                    ; $00A918
        movem.l      d0-d2/d4-d7/a0-a1/a4-a5, -(a7)                ; $00A91C
        tst.w        d0                                            ; $00A920
        bmi.b        loc_00A932                                    ; $00A922
        bne.w        DrawAlternateVisibleWallFaceOrientation                        ; $00A924
        cmpi.w       #$80, rPlayerCellFractionX(a6)                              ; $00A928
        bcs.w        DrawAlternateVisibleWallFaceOrientation                        ; $00A92E
...
loc_00A932:
        ...
        lsl.w        #$8, d1                                       ; $00A93C
        addi.w       #$80, d0                                      ; $00A93E
        bsr.w        TransformSegmentEndpointAToCamera                        ; $00A942
        addi.w       #$100, d1                                     ; $00A946
        bsr.w        TransformSegmentEndpointBToCamera                        ; $00A94A
