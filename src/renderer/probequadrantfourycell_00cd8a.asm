...
ProbeQuadrantFourYCell:
; A1 cell: class 3 uses D6+slopeY; >=6 dispatches with the cursor banks swapped.
        andi.w       #$ff, d3                                      ; $00CD8A
...
loc_00CDCE:
        cmpa.l       rCurrentWallMapCellPointer(a6), a0                                ; $00CDCE
        beq.w        loc_00CD26                                    ; $00CDD2
        move.l       a0, rCurrentWallMapCellPointer(a6)                                ; $00CDD6
        clr.w        d4                                            ; $00CDDA
        move.b       (a0), d4                                      ; $00CDDC
        lsl.w        #$3, d4                                       ; $00CDDE
        ...
        move.l       a0, rCellRenderStateSourcePointer(a6)                                ; $00CDEA
        ...
        bsr.w        RenderWallEdgeX1                        ; $00CE20
        movem.w      (a7)+, d0-d1/d3                               ; $00CE24
        bra.w        RenderWallEdgeY0                        ; $00CE28

loc_00CE2C:
        bra.w        RenderWallEdgeX1                        ; $00CE2C

loc_00CE30:
        cmpa.l       rCurrentWallMapCellPointer(a6), a1                                ; $00CE30
        beq.w        loc_00CD26                                    ; $00CE34
        move.w       d4, d0                                        ; $00CE38
        move.w       d5, d1                                        ; $00CE3A
        move.w       d6, d2                                        ; $00CE3C
        movea.l      a1, a0                                        ; $00CE3E
        move.l       a0, rCurrentWallMapCellPointer(a6)                                ; $00CE40
        clr.w        d4                                            ; $00CE44
        move.b       (a0), d4                                      ; $00CE46
        lsl.w        #$3, d4                                       ; $00CE48
        ...
        move.l       a0, rCellRenderStateSourcePointer(a6)                                ; $00CE54
        add.w        rPlayerCellX(a6), d0                          ; $00CE58
        lsl.w        #$8, d0                                       ; $00CE5C
        add.w        rPlayerCellY(a6), d1                          ; $00CE5E
        lsl.w        #$8, d1                                       ; $00CE62
        bra.w        RenderWallEdgeY0                        ; $00CE64
        ifne *-$CE68
        fail "ROM end moved"
        endif
