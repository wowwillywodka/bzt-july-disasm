...
; JULY LOCAL REVIEW:
; Software-scaled object tiles 61/62 for hit particle states 0/1/2.
        ifne *-$1DB4C
        fail "ROM start moved"
        endif

DrawHitParticle:
; State 0 selects object tile 61; state 1 or 2 selects tile 62.
        move.w       d5, rSoftwareSpriteProjectionScale(a6)                                ; $01DB4C
        move.w       d5, d2                                        ; $01DB50
        move.w       rPlayerViewOffsetZ(a6), d3                                ; $01DB52
        sub.w        rTransitHeightOffset(a6), d3                                ; $01DB56
        ...
        andi.w       #$1, d0                                       ; $01DB88
        move.w       d0, rSoftwareSpriteMirrorFlag(a6)                                ; $01DB8C
        move.w       d5, d0                                        ; $01DB90
        move.w       d5, d4                                        ; $01DB92
        addi.w       #$80, d7                                      ; $01DB94
        mulu.w       d7, d4                                        ; $01DB98
...
loc_01DBBC:
        ...
        andi.w       #$1, d0                                       ; $01DBC8
        move.w       d0, rSoftwareSpriteMirrorFlag(a6)                                ; $01DBCC
        move.w       d5, d0                                        ; $01DBD0
        move.w       d5, d4                                        ; $01DBD2
...
loc_01DBF6:
        ...
        andi.w       #$1, d0                                       ; $01DC02
        move.w       d0, rSoftwareSpriteMirrorFlag(a6)                                ; $01DC06
        move.w       d5, d0                                        ; $01DC0A
        asr.w        #$2, d0                                       ; $01DC0C
        move.w       d0, d4                                        ; $01DC0E
        asr.w        #$1, d4                                       ; $01DC10
