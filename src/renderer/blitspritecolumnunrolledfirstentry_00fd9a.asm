...
; JULY LOCAL REVIEW: first computed entry in SpriteColumnEntryPointers.
; The unrolled transparent-pixel copy continues into the next partition.
; This is an entry into a shared blitter, not a standalone RTS procedure.
        ifne *-$FD9A
        fail "ROM start moved"
        endif

BlitSpriteColumnUnrolledFirstEntry:
        addq.w       #$4, a0                                       ; $00FD9A
        move.b       (a2)+, d1                                     ; $00FD9C
