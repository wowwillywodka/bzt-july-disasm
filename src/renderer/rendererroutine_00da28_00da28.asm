...
; Блиттер текстурного столбца с гор.клипом: глубинный z-тест по (A4), отсев по экрану ±0x28 от центра 0x50, масштабирование столбца через lsl/divu (перспект.коррекция U), запись пикселей шагом 4 в буфер кадра (A0), диспетч через таблицу процедур (-0x712c,a6)
        ifne *-$DA28
        fail "ROM start moved"
        endif

RendererRoutine_00DA28:
        ...
        move.w       d0, (a4)                                      ; $00DA36
        move.w       d0, d3                                        ; $00DA38
        muls.w       -$71d8(a6), d3                                ; $00DA3A
        move.w       -$6e3e(a6), d4                                ; $00DA3E
        ext.l        d4                                            ; $00DA42
        add.l        d4, d3                                        ; $00DA44
        asr.l        #$6, d3                                       ; $00DA46
        cmpi.w       #$50, d0                                      ; $00DA48
...
; Shifted scaler call: independent top/bottom copy tails from $3FEC + height*2 +/- shift*4.
        jsr          (a3)                                          ; $00DA8A
        addq.w       #$8, a7                                       ; $00DA8C
...
loc_00DC40:
        ...
        add.l        d1, d2                                        ; $00DC44
        addq.w       #$2, a4                                       ; $00DC46
        add.w        d6, -$717a(a6)                                ; $00DC48
        tst.b        -$717a(a6)                                    ; $00DC4C
        beq.b        loc_00DCA6                                    ; $00DC50
        move.w       -$717a(a6), d4                                ; $00DC52
        clr.b        -$717a(a6)                                    ; $00DC56
        clr.b        d4                                            ; $00DC5A
        asr.w        #$3, d4                                       ; $00DC5C
        adda.w       d4, a1                                        ; $00DC5E
        adda.w       d4, a2                                        ; $00DC60
        asr.w        #$1, d4                                       ; $00DC62
        add.w        d4, -$7176(a6)                                ; $00DC64
        tst.b        -$7176(a6)                                    ; $00DC68
        beq.b        loc_00DCA6                                    ; $00DC6C
        clr.l        d4                                            ; $00DC6E
        move.b       -$7176(a6), d4                                ; $00DC70
        clr.b        -$7176(a6)                                    ; $00DC74
        lsl.b        #$2, d4                                       ; $00DC78
