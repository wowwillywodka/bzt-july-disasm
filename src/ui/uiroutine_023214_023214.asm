...
UiRoutine_023214:
        ...
        adda.w       d0, a0                                        ; $02324C
        move.l       (a0)+, -$76c0(a6)                             ; $02324E
        move.w       (a0)+, -$76bc(a6)                             ; $023252
...
loc_023256:
        ...
        adda.w       d0, a0                                        ; $023262
        move.l       (a0)+, -$76c6(a6)                             ; $023264
        move.w       (a0)+, -$76c2(a6)                             ; $023268
...
loc_02326C:
        ...
        adda.w       d0, a0                                        ; $023278
        move.l       (a0)+, -$76cc(a6)                             ; $02327A
        move.w       (a0)+, -$76c8(a6)                             ; $02327E
...
loc_023282:
        ...
        adda.w       d0, a0                                        ; $02328E
        move.l       (a0)+, -$76d2(a6)                             ; $023290
        move.w       (a0)+, -$76ce(a6)                             ; $023294
...
loc_023298:
        ...
        adda.w       d0, a0                                        ; $0232A4
        move.l       (a0)+, -$76d8(a6)                             ; $0232A6
        move.w       (a0)+, -$76d4(a6)                             ; $0232AA

loc_0232AE:
        move.w       -$7784(a6), d0                                ; $0232AE
        cmpi.w       #$40, d0                                      ; $0232B2
        ...
        adda.w       d0, a0                                        ; $0232D2
        move.l       (a0)+, -$76c0(a6)                             ; $0232D4
        move.w       (a0)+, -$76bc(a6)                             ; $0232D8
...
loc_0232DC:
        ...
        adda.w       d0, a0                                        ; $0232E8
        move.l       (a0)+, -$76c6(a6)                             ; $0232EA
        move.w       (a0)+, -$76c2(a6)                             ; $0232EE
...
loc_0232F2:
        ...
        adda.w       d0, a0                                        ; $0232FE
        move.l       (a0)+, -$76cc(a6)                             ; $023300
        move.w       (a0)+, -$76c8(a6)                             ; $023304
...
loc_023308:
        ...
        adda.w       d0, a0                                        ; $023314
        move.l       (a0)+, -$76d2(a6)                             ; $023316
        move.w       (a0)+, -$76ce(a6)                             ; $02331A
...
loc_02331E:
        ...
        adda.w       d0, a0                                        ; $02332A
        move.l       (a0)+, -$76d8(a6)                             ; $02332C
        move.w       (a0)+, -$76d4(a6)                             ; $023330
