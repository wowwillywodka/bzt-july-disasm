...
UiRoutine_021784:
        ...
        move.w       #$40, d2                                      ; $0217AC
        move.w       #$1, d3                                       ; $0217B0
        jsr          loc_021EF2.l                                  ; $0217B4
        lea.l        RunMissionSelection.l, a0                     ; $0217BA
        moveq        #$5, d1                                       ; $0217C0
        jsr          loc_022010.l                                  ; $0217C2
        move.w       #$f, d0                                       ; $0217C8
