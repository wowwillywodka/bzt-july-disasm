...
; Grant item ID D0 to an inventory slot and load/update its HUD art.
; Item type 3 (Bullet Proof Vest) uses dedicated slot 7 and selects that
; slot as the HP-absorbing charge source. D7 reports failure if the
; ordinary five-slot inventory is full.
        ifne *-$11C78
...
loc_011D44:
        tst.w        rVBlankTransferPhasesRemaining(a6)                                    ; $011D44
        bne.b        loc_011D44                                    ; $011D48
        move.w       d7, d6                                        ; $011D4A
        lsl.w        #$8, d6                                       ; $011D4C
        lsl.w        #$1, d6                                       ; $011D4E
        addi.w       #$93e0, d6                                    ; $011D50
        move.w       rItemGrantAmountOverride(a6), d2                                ; $011D54
...
loc_011D7E:
        ...
        bsr.w        UploadInventorySlotIconToVram                           ; $011DA0
...
loc_011DB8:
        tst.w        rVBlankTransferPhasesRemaining(a6)                                    ; $011DB8
...
loc_011E00:
        move.w       d0, (a0)                                      ; $011E00
        move.w       rItemGrantAmountOverride(a6), $2(a0)                            ; $011E02
...
loc_011E22:
        ...
        bsr.w        UploadInventorySlotIconToVram                           ; $011E40
        bsr.w        RequestWeaponFromSelectedItem                 ; $011E44
        movem.w      (a7)+, d0/d7                                  ; $011E48

loc_011E4C:
        lea.l        rInventoryHudBlinkTicks(a6), a1                                ; $011E4C
        move.b       #$3, (a1, d7.w)                               ; $011E50
        cmpi.w       #$9, d0                                       ; $011E56
        bne.w        loc_011EFC                                    ; $011E5A
        tst.w        rNightVisionInventorySlotIndex(a6)                                    ; $011E5E
        bpl.w        loc_011EFC                                    ; $011E62
        move.w       d7, rNightVisionInventorySlotIndex(a6)                                ; $011E66
        bsr.w        ApplyEffectColorPalette                              ; $011E6A
        bra.w        loc_011EFC                                    ; $011E6E

loc_011E72:
        lea.l        rInventorySlots(a6), a0                       ; $011E72
        adda.w       #$14, a0                                      ; $011E76
        move.w       rItemGrantAmountOverride(a6), $2(a0)                            ; $011E7A
...
loc_011E8E:
        tst.w        rFlashlightInventorySlotIndex(a6)                                    ; $011E8E
        bpl.w        loc_011EFC                                    ; $011E92
        move.w       d0, (a0)                                      ; $011E96
        move.w       #$5, rFlashlightInventorySlotIndex(a6)                               ; $011E98
        move.w       #$10, rVisibleRayCellRadius(a6)                              ; $011E9E
        bra.b        loc_011EFC                                    ; $011EA4

loc_011EA6:
        lea.l        rInventorySlots(a6), a0                       ; $011EA6
        adda.w       #$18, a0                                      ; $011EAA
        move.w       rItemGrantAmountOverride(a6), $2(a0)                            ; $011EAE
...
loc_011EC2:
        tst.w        rTimedItemSlot6Index(a6)                                    ; $011EC2
        bpl.b        loc_011ED2                                    ; $011EC6
        move.w       d0, (a0)                                      ; $011EC8
        move.w       #$6, rTimedItemSlot6Index(a6)                               ; $011ECA
        bra.b        loc_011EFC                                    ; $011ED0

loc_011ED2:
        lea.l        rInventorySlots(a6), a0                       ; $011ED2
        adda.w       #$1c, a0                                      ; $011ED6
        move.w       rItemGrantAmountOverride(a6), $2(a0)                            ; $011EDA
...
loc_011EEE:
        tst.w        rBulletProofVestSlotIndex(a6)                                    ; $011EEE
        bpl.b        loc_011EFC                                    ; $011EF2
        move.w       d0, (a0)                                      ; $011EF4
        move.w       #$7, rBulletProofVestSlotIndex(a6)                               ; $011EF6
