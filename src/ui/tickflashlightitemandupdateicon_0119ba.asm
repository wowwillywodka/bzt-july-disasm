...
TickFlashlightItemAndUpdateIcon:
        tst.w        rVBlankTransferPhasesRemaining(a6)                                    ; $0119BA
        bne.b        TickFlashlightItemAndUpdateIcon                              ; $0119BE
        move.w       rFlashlightInventorySlotIndex(a6), d0                                ; $0119C0
        lsl.w        #$8, d0                                       ; $0119C4
        lsl.w        #$1, d0                                       ; $0119C6
        ...
        move.w       rFlashlightInventorySlotIndex(a6), d0                                ; $0119D8
        mulu.w       #$4, d0                                       ; $0119DC
...
loc_011A1A:
        move.w       #$1, rInventorySlotDepletionFlag(a6)                               ; $011A1A
