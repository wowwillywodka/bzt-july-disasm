...
; Character-selection UI helper (five portraits/biographies), not a geometry-episode selector. See docs/GAME_FLOW.md.
        ...
        lea.l        CharacterMenuBackgroundTiles.l, a0            ; $07B18E
        move.w       #$86f, d7                                     ; $07B194

loc_07B198:
        move.l       (a0)+, VDP_DATA.l                             ; $07B198
        dbra         d7, loc_07B198                                ; $07B19E
        lea.l        CharacterMenuFrameTiles.l, a0                 ; $07B1A2
        lea.l        CharacterMenuFrameRow.l, a1                   ; $07B1A8
        move.w       #$546, d0                                     ; $07B1AE
        move.w       #$18, d1                                      ; $07B1B2
        move.w       #$20, d2                                      ; $07B1B6
        jsr          UploadTileRectangle.l                         ; $07B1BA
        lea.l        CharacterMenuFrameTiles.l, a0                 ; $07B1C0
        lea.l        CharacterMenuFrameTilemap.l, a1               ; $07B1C6
        ...
        move.w       #$0, d0                                       ; $07B1E4
        jsr          VideoRoutine_021E4A.l                         ; $07B1E8
