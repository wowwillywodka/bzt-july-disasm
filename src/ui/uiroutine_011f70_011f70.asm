...
UiRoutine_011F70:
        ...
        move.l       d1, (a0)+                                     ; $011F9A
        move.l       d1, (a0)                                      ; $011F9C
        move.l       #AlternateWallColumnScalers, rWallColumnScalerTable(a6) ; $011F9E
        move.l       rZoneBackgroundProfile0(a6), rActiveSceneBackgroundProfile(a6) ; $011FA6
        move.w       #$10, -$7122(a6)                              ; $011FAC
        jmp          loc_00DCB8.l                                  ; $011FB2
...
loc_011FB8:
        ...
        move.l       d1, (a0)+                                     ; $011FCC
        move.l       d1, (a0)                                      ; $011FCE
        move.l       #AlternateWallColumnScalers, rWallColumnScalerTable(a6) ; $011FD0
        move.l       rZoneBackgroundProfile3(a6), rActiveSceneBackgroundProfile(a6) ; $011FD8
        move.w       #$10, -$7122(a6)                              ; $011FDE
        jmp          loc_00DCB8.l                                  ; $011FE4
        ifne *-$11FEA
        fail "ROM end moved"
        endif
