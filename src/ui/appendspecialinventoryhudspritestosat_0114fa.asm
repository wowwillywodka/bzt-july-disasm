...
AppendSpecialInventoryHudSpritesToSat:
        bsr.w        AppendInventorySlot6StatusSprite                              ; $0114FA
        bsr.w        AppendInventorySlot5StatusSprite                              ; $0114FE
...
loc_011528:
        lea.l        rInventoryHudBlinkTicks(a6), a1                                ; $011528
        move.w       rSpriteAttributeNextLink(a6), d0                                ; $01152C
        ori.w        #$f00, d0                                     ; $011530
        clr.w        d1                                            ; $011534
...
loc_011550:
        ...
        addq.w       #$1, rSpriteAttributeNextLink(a6)                               ; $01156A
        rts                                                        ; $01156E
        ifne *-$11570
        fail "ROM end moved"
        endif
