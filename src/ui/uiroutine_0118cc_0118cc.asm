...
UiRoutine_0118CC:
        tst.w        -$7ffe(a6)                                    ; $0118CC
        bne.b        UiRoutine_0118CC                              ; $0118D0
        move.w       -$6f6c(a6), d0                                ; $0118D2
        lsl.w        #$8, d0                                       ; $0118D6
        lsl.w        #$1, d0                                       ; $0118D8
        ...
        lsr.w        #$8, d0                                       ; $011926
        addq.w       #$1, d0                                       ; $011928
        jmp          UiRoutine_020944.l                            ; $01192A

loc_011930:
        move.w       #$1, -$558e(a6)                               ; $011930
...
loc_011962:
        ...
        move.w       #$ffff, -$6f6c(a6)                            ; $0119AA
        bra.w        UiRoutine_011FEA                              ; $0119B0

loc_0119B4:
        move.w       d7, -$6f6c(a6)                                ; $0119B4
        rts                                                        ; $0119B8
        ifne *-$119BA
        fail "ROM end moved"
        endif
