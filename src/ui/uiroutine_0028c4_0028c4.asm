...
; Построение экрана-заставки/меню: VDP-инит ($c00004), bsr $1a78/$1a50, выбор тайлсета по (-0x6f6c,A6) ((-0x42ec)/(-0x42e8)), заливка CRAM 32 long из (A0), bsr $cc0/$c70, распаковка фона jsr $98b98 (byte-pair), тайлмап jsr $21ebc; чтение записей нейметабла из VRAM через порт $C00000 (команды $0b100003/$04ca0003 + задержка 0x2bbc) и расчёт VRAM-адреса; заливка плана 0xffffffff (8 long), jsr $209fe, диспетч по (-0x6fa6,A6) (clamp 0..4, две таблицы 0x1be(PC)/0x2ba8) с пушем адреса
        ifne *-$28C4
...
UiRoutine_0028C4:
        ...
        clr.w        -$7ffe(a6)                                    ; $0028D6
        bsr.w        ResetVerticalScroll                           ; $0028DA
        cmpi.w       #$ffff, -$6f6c(a6)                            ; $0028DE
...
loc_002904:
        ...
        clr.w        -$2260(a6)                                    ; $002912
        clr.w        -$2262(a6)                                    ; $002916
...
; Decompress gameplay frame tiles to VRAM tile $301; map at GameplayFrameTilemap, 40x28.
        ...
        move.l       VDP_DATA.l, -$7226(a6)                        ; $00296A
        ...
        move.l       d7, (a4)                                      ; $0029C0
        move.l       d7, (a4)                                      ; $0029C2
        jsr          UiRoutine_00E1E2.l                            ; $0029C4
        move.w       rRemainingEnemyCount(a6), d6                  ; $0029CA
        jsr          UiRoutine_0209FE.l                            ; $0029CE
...
loc_0029E4:
        ...
        lea.l        CharacterPortraitPalettePointers.l, a1        ; $0029EE
        ...
        jsr          VideoRoutine_01173A.l                         ; $002A32
