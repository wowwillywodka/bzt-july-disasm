...
; Вывод палитры для двузначного числа: разбивает D0 на десятки/единицы, индексирует таблицу цветов @0x164148 и пишет пары цветовых слов в VDP-порт данных (A4)
        ifne *-$20944
...
UiRoutine_020944:
        ...
        movea.l      #InventoryIconBankTail, a2                    ; $020948
        clr.w        d1                                            ; $02094E
        andi.w       #$7f, d0                                      ; $020950
        cmpi.w       #$a, d0                                       ; $020954
