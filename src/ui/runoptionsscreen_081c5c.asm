...
; Reviewed call entry (procedure): Initializes options screen, then reads input and updates cursor/options.
RunOptionsScreen:
...
loc_081EDE:
        ...
        jsr          GemsStopAll(pc)                       ; $081EEA
        move.w       ramSoundOptions.l, d0                         ; $081EEE
        btst.l       #$0, d0                                       ; $081EF4
        beq.w        loc_081F04                                    ; $081EF8
        move.w       #$41, d0                                      ; $081EFC
        jsr          StoreCurrentSoundSequenceAndPlayEvent(pc)                                ; $081F00
