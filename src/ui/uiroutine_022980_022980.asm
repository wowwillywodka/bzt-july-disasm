...
loc_022B34:
        ...
        clr.w        -$76e0(a6)                                    ; $022B3E
        clr.w        -$76de(a6)                                    ; $022B42
        clr.w        -$76dc(a6)                                    ; $022B46
        clr.w        -$7786(a6)                                    ; $022B4A
        clr.w        -$7784(a6)                                    ; $022B4E
        move.l       #TitleScrollWordSequences, -$7782(a6)         ; $022B52
        move.l       #$22fd6, -$777e(a6)                           ; $022B5A
        move.l       #TitleAnimationCurves, -$777a(a6)             ; $022B62
        move.l       #TitleAnimationCurves, -$7776(a6)             ; $022B6A
        jsr          WaitForVBlank.l                               ; $022B72
        move.w       #$8164, VDP_CONTROL.l                         ; $022B78
        clr.w        -$778c(a6)                                    ; $022B80
...
loc_022B8E:
        ...
        move.w       #$1, -$7fbe(a6)                               ; $022BEC
        lea.l        -$7fbc(a6), a0                                ; $022BF2
        move.l       a0, -$7fc2(a6)                                ; $022BF6
        bsr.w        UiRoutine_022F38                              ; $022BFA
        bsr.w        UiRoutine_023214                              ; $022BFE
        addq.w       #$1, -$76de(a6)                               ; $022C02
        cmpi.w       #$4, -$76de(a6)                               ; $022C06
        bne.w        loc_022C9A                                    ; $022C0C
        clr.w        -$76de(a6)                                    ; $022C10
        move.w       -$76e0(a6), d2                                ; $022C14
        move.w       d2, d3                                        ; $022C18
        addi.w       #$54, d3                                      ; $022C1A
        andi.w       #$ff, d3                                      ; $022C1E
        addi.w       #$e000, d3                                    ; $022C22
        movea.l      #VDP_DATA, a4                                 ; $022C26
        addq.w       #$2, -$76e0(a6)                               ; $022C2C
...
loc_022C9A:
        subq.w       #$2, -$76dc(a6)                               ; $022C9A
        move.w       -$76dc(a6), d0                                ; $022C9E
        lea.l        -$76ba(a6), a0                                ; $022CA2
        move.w       #$cf, d7                                      ; $022CA6

loc_022CAA:
        move.w       d0, (a0)+                                     ; $022CAA
        dbra         d7, loc_022CAA                                ; $022CAC
        move.w       -$7786(a6), d0                                ; $022CB0
        cmpi.w       #$40, d0                                      ; $022CB4
...
loc_022CE8:
        ...
        move.w       #$f, d7                                       ; $022D04
        movea.l      -$7fc2(a6), a2                                ; $022D08
        lea.l        TitleStaticSpriteMappings(pc), a0             ; $022D0C
        move.w       -$7fbe(a6), d0                                ; $022D10
...
loc_022D66:
        move.l       a2, -$7fc2(a6)                                ; $022D66
        move.w       d0, -$7fbe(a6)                                ; $022D6A
        move.l       #$ff0946, d4                                  ; $022D6E
        move.w       #$1c0, d6                                     ; $022D74
        move.w       #$bc00, d5                                    ; $022D78
        jsr          QueueVramDma.l                                ; $022D7C
        movea.l      -$7fc2(a6), a0                                ; $022D82
        cmpa.l       #$ff0044, a0                                  ; $022D86
...
loc_022DE2:
        cmpi.w       #$faa0, -$76dc(a6)                            ; $022DE2
        bne.b        loc_022DEE                                    ; $022DE8
        bsr.w        UiRoutine_022EB4                              ; $022DEA
...
loc_022DEE:
        ...
        tst.w        -$778c(a6)                                    ; $022E02
        bne.b        loc_022E4E                                    ; $022E06
        move.w       #$1, -$778c(a6)                               ; $022E08
...
loc_022E12:
        ...
        tst.w        -$778c(a6)                                    ; $022E22
        beq.b        loc_022E2E                                    ; $022E26
        move.w       #$1, -$778c(a6)                               ; $022E28
...
loc_022E2E:
        ...
        tst.w        -$778c(a6)                                    ; $022E3E
        beq.b        loc_022E4A                                    ; $022E42
        move.w       #$2, -$778c(a6)                               ; $022E44
