...
; D1.w=aim allowance,D2.w=aim center+64. A1=selected target or0. Flags by scene-height sign (40/80/08), same floor, projected depth/cross-product gates and strict reciprocal-depth improvement over FF8ACA. No five-ray LOS. Floor0 retained scene-effect tail may call $28A4.
        ...
        move.w       $aca(a6), d0                                  ; $01E932
        move.w       #$40, rWeaponTargetFlagsMask(a6)              ; $01E936
        tst.w        -$71d8(a6)                                    ; $01E93C
        beq.b        WeaponAimVisitActor                           ; $01E940
        bmi.b        loc_01E94C                                    ; $01E942
        move.w       #$80, rWeaponTargetFlagsMask(a6)              ; $01E944
        bra.b        WeaponAimVisitActor                           ; $01E94A

loc_01E94C:
        move.w       #$8, rWeaponTargetFlagsMask(a6)               ; $01E94C
...
WeaponAimVisitActor:
        ...
        move.w       d4, d5                                        ; $01E972
        muls.w       -$71f2(a6), d4                                ; $01E974
        move.w       ActorY(a0), d3                                ; $01E978
        sub.w        rPlayerY(a6), d3                              ; $01E97C
        move.w       d3, d6                                        ; $01E980
        muls.w       -$71f0(a6), d3                                ; $01E982
        add.l        d3, d4                                        ; $01E986
        muls.w       -$71f2(a6), d6                                ; $01E988
        muls.w       -$71f0(a6), d5                                ; $01E98C
        sub.l        d5, d6                                        ; $01E990
        asr.l        #$6, d4                                       ; $01E992
        cmpi.l       #$2, d4                                       ; $01E994
...
loc_01EA0A:
        ...
        move.b       #$20, -$6f52(a6)                              ; $01EA10
        jmp          loc_0028A4.w                                  ; $01EA16
        ifne *-$1EA1A
        fail "ROM end moved"
        endif
