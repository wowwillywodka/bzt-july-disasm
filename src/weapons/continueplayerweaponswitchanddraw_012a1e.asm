...
WeaponDrawCurrent:
        ...
        move.w       rViewSwayWeaponPhaseScratch(a6), d1                                ; $012A3C
        add.w        d1, d0                                        ; $012A40
        move.w       rViewSwayAngleOffset(a6), d1                                ; $012A42
        add.w        d1, d1                                        ; $012A46
        clr.w        d2                                            ; $012A48
        move.b       rCurrentWeaponId(a6), d2                      ; $012A4A
        lsl.w        #$2, d2                                       ; $012A4E
        movea.l      HeldWeaponDrawHandlers(pc, d2.w), a1          ; $012A50
; Rear view restores SAT write pointer after draw call, but does not undo phase, ammo, allocations, damage or sprite-link counter.
        tst.w        rRearViewActive(a6)                                    ; $012A54
        beq.b        loc_012A66                                    ; $012A58
        move.l       rSpriteAttributeTableWritePointer(a6), -(a7)                             ; $012A5A
        jsr          (a1)                                          ; $012A5E
        move.l       (a7)+, rSpriteAttributeTableWritePointer(a6)                             ; $012A60
        rts                                                        ; $012A64
