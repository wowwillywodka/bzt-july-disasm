...
loc_0137DA:
        movea.l      -$7fc2(a6), a2                                ; $0137DA
        move.w       d0, (a2)+                                     ; $0137DE
        move.w       -$7fbe(a6), d2                                ; $0137E0
        ori.w        #$b00, d2                                     ; $0137E4
        addq.w       #$1, -$7fbe(a6)                               ; $0137E8
        move.w       d2, (a2)+                                     ; $0137EC
        move.w       #$a4ef, (a2)+                                 ; $0137EE
        move.w       d1, (a2)+                                     ; $0137F2
        move.l       a2, -$7fc2(a6)                                ; $0137F4
        ...
        subi.w       #$1d, d0                                      ; $013804
        add.w        d2, d0                                        ; $013808
        movea.l      -$7fc2(a6), a2                                ; $01380A
        move.w       d0, (a2)+                                     ; $01380E
        move.w       -$7fbe(a6), d2                                ; $013810
        ori.w        #$a00, d2                                     ; $013814
        addq.w       #$1, -$7fbe(a6)                               ; $013818
        move.w       d2, (a2)+                                     ; $01381C
        move.w       #$a4fb, d3                                    ; $01381E
        btst.b       #$0, -$6f6f(a6)                               ; $013822
        beq.b        loc_01382E                                    ; $013828
        ori.w        #$800, d3                                     ; $01382A

loc_01382E:
        btst.b       #$1, -$6f6f(a6)                               ; $01382E
