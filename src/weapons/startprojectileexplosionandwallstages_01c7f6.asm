...
; Common explosion setup: sound$18, shake30, callbacks Draw/UpdateProjectileExplosion, hit=RTS, Flags AND$FF37, effect counter0. 5x5 wall-stage activation. Area hit occurs later at counter2, NOT here.
        clr.w        -$55a0(a6)                                    ; $01C7F6
        clr.w        -$559e(a6)                                    ; $01C7FA
        move.w       #$18, d0                                      ; $01C7FE
        move.l       a0, -(a7)                                     ; $01C802
        jsr          SoundRoutine_00DF64.l                         ; $01C804
        movea.l      (a7)+, a0                                     ; $01C80A
        move.w       #$1e, -$559e(a6)                              ; $01C80C
...
loc_01C812:
        ...
        move.l       a0, -(a7)                                     ; $01C83E
        move.l       #ActorsRoutine_01EE24, ActorLinkCallback(a0)  ; $01C840
        lea.l        -$6fdc(a6), a1                                ; $01C848
        move.b       #$12, (a1)+                                   ; $01C84C
