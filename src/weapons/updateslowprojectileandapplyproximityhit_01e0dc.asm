...
UpdateSlowProjectileAndApplyProximityHit:
...
loc_01E0FE:
        ...
        tst.w        rPlayerViewOffsetZ(a6)                                    ; $01E172
        bmi.b        loc_01E1AC                                    ; $01E176
        bra.b        loc_01E182                                    ; $01E178

loc_01E17A:
        tst.w        rPlayerViewOffsetZ(a6)                                    ; $01E17A
...
; A0 now points to the target; D0.w=$1F4 and D3/D4 carry impact direction.
; Target may be the player proxy, an enemy, or another callback-bearing actor.
        movea.l      ActorHitCallback(a0), a1                      ; $01E186
        jsr          (a1)                                          ; $01E18A
        clr.w        rStatusSoundScriptActive(a6)                                    ; $01E18C
        clr.w        rSoundEffectCooldown(a6)                                    ; $01E190
        movea.l      (a7), a0                                      ; $01E194
        move.w       #$2a, d0                                      ; $01E196
        jsr          RouteSoundEventByActorFloor.l                         ; $01E19A
        movea.l      (a7)+, a0                                     ; $01E1A0
        move.w       #$f, rSoundEffectCooldown(a6)                               ; $01E1A2
