...
; Buligun immediate shot: lowering guard only, consume$100, activate wall stages, select aim target. D0=(distance^2>>8) ASR.W1; characters0/2 halve again. Unsigned word threshold<$400.
        ...
        clr.w        rStatusSoundScriptActive(a6)                                    ; $014628
        clr.w        rSoundEffectCooldown(a6)                                    ; $01462C
        move.w       #$1d, d0                                      ; $014630
        jsr          PlaySoundEventAndMaybeSendLink.l                         ; $014634
        move.w       #$14, rSoundEffectCooldown(a6)                              ; $01463A
...
loc_014676:
        move.w       rViewSwayAngleOffset(a6), d2                                ; $014676
        addi.w       #$40, d2                                      ; $01467A
...
loc_0146D8:
        jsr          ClassifyPlayerCellForWeapon.l                       ; $0146D8
