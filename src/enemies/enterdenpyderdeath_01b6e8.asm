...
; Sound$0A; corpse state4 (NOT pickup-eligible3), mode always CB/counter4, overwrites C8/C9. Corpse transition also ends state4, so normal corpse does not grant pickup.
        move.l       a0, -(a7)                                     ; $01B6E8
        move.w       #$a, d0                                       ; $01B6EA
        jsr          RouteSoundEventByActorFloor.l                         ; $01B6EE
        ...
        addq.w       #$1, rEnemyDeathsRecorded(a6)                               ; $01B70C
        clr.b        ActorUpdateDelay(a0)                          ; $01B710
        move.l       #HitDenpyderCorpse, ActorHitCallback(a0)      ; $01B714
        move.l       #PlaceCorpseCellAndRemoveActor, ActorExitCallback(a0) ; $01B71C
        tst.b        ActorMarkerTracked(a0)                        ; $01B724
        beq.b        loc_01B732                                    ; $01B728
        move.l       #WriteTrackedCorpseCellAndRemoveActor, ActorExitCallback(a0) ; $01B72A
...
loc_01B768:
        ...
        lea.l        rSharedScratchBuffer(a6), a1                                ; $01B770
        move.b       #$12, (a1)+                                   ; $01B774
        ...
        lea.l        rSharedScratchBuffer(a6), a0                                ; $01B78A
