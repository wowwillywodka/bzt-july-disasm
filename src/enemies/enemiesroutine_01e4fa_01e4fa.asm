...
; Поиск ближайшего актёра нужной фракции/типа: цикл по списку (-0x57c4/-0x57c6,A6) с фильтром маски (0x4,A0)&D5 и типа (0x36,A0)==D7, минимизирует дистанцию (dfe4) в D6, возвращает указатель цели в A1; учитывает и игрока
        ifne *-$1E4FA
        fail "ROM start moved"
        endif

EnemiesRoutine_01E4FA:
        ...
        move.w       $24(a0), d3                                   ; $01E518
        move.w       $26(a0), d4                                   ; $01E51C
        move.b       $36(a0), d7                                   ; $01E520

loc_01E524:
        move.w       rActiveActorCount(a6), -$6fde(a6)             ; $01E524
...
loc_01E530:
        ...
        move.w       $4(a3), d0                                    ; $01E534
        and.w        d5, d0                                        ; $01E538
        cmp.w        d5, d0                                        ; $01E53A
        bne.b        loc_01E55E                                    ; $01E53C
        cmp.b        $36(a3), d7                                   ; $01E53E
        bne.b        loc_01E55E                                    ; $01E542
        move.w       d3, d0                                        ; $01E544
        move.w       d4, d1                                        ; $01E546
        sub.w        $24(a3), d0                                   ; $01E548
        sub.w        $26(a3), d1                                   ; $01E54C
