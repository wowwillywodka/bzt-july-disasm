...
; Maintained assembly input; no extraction occurs during build.
        ...
        move.l       #$1df3a, ActorUpdateCallback(a0)              ; $01DFBC
        move.l       #$1df66, ActorDrawCallback(a0)                ; $01DFC4
        ...
        clr.w        -$55a0(a6)                                    ; $01DFF0
        clr.w        -$559e(a6)                                    ; $01DFF4
        move.l       a0, -(a7)                                     ; $01DFF8
        move.w       #$18, d0                                      ; $01DFFA
        jsr          SoundRoutine_00DF64.l                         ; $01DFFE
        movea.l      (a7)+, a0                                     ; $01E004
        move.w       #$1e, -$559e(a6)                              ; $01E006
        tst.w        rLinkRole(a6)                                 ; $01E00C
        beq.b        loc_01E03E                                    ; $01E010
        move.l       #$1ee4e, ActorLinkCallback(a0)                ; $01E012
        lea.l        -$6fdc(a6), a1                                ; $01E01A
        move.b       #$12, (a1)+                                   ; $01E01E
